...
* [How to create a Snap! Extension (wiki article)](https://github.com/Technoboy10/snap-server/wiki/How-to-create-a-Snap!-Extension)
* [Base server GitHub link](https://github.com/Technoboy10/snap-server)
